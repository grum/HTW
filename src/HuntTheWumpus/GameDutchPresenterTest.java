...
public class GameDutchPresenterTest extends TestCase {
    ...
    public void testNortAndSouthAvailable() throws Exception {
        ...
        g.addPath(1, 3, NORTH);
        g.putPlayerInCavern(1);
        assertEquals("Jij kan van hier naar het noorden of zuiden gaan", p.getAvailableDirections());
    }
    ...
    public void testFourDirections() throws Exception {
        ...
        g.addPath(1, 5, NORTH);
        g.putPlayerInCavern(1);
        assertEquals("Jij kan van hier naar het noorden, zuiden, oosten of westen gaan", p.getAvailableDirections());
    }
}
